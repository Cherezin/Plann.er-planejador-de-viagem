    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
          ...
          <button className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font font-medium flex items-center gap-2 hover:bg-lime-400'>
            Continuar 
            <ArrowRight className='size-5' />
            </button>
        </div>

        <p className="text-sn text-zinc-500">Ao planejar sua viagem pela plann.er você automaticamente concorda <br />
